...
class Gamut:
    ...
    def intersect(self, other: Gamut | SyntheticGamut) -> Gamut:
        ...
        """
        from gamut_volume.geometry.volume import intersect_gamuts
    ...
    def plot_surface(
        ...
        """
        from gamut_volume.plotting.surface import plot_surface
    ...
    def plot_rings(
        ...
        Returns:
            The matplotlib Figure containing the plot.
        """
        from gamut_volume.plotting.rings import plot_rings
